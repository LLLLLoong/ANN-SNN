...
import torch
import os
from Preprocess.augment import Cutout, CIFAR10Policy, ImageNetPolicy
...
def GetImageNet(batchsize):
    ...
    train_data = datasets.ImageFolder(root='/home/Dataset/ImageNet/train', transform=trans_t)
    ...
    test_data = datasets.ImageFolder(root='/home/Dataset/ImageNet/val', transform=trans)
